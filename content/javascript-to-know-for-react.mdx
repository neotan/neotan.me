...
<callout-info> 一定要閱讀 MDN 的文章，你肯定會學到一些新東西。讀完後嘗試使用單行
解構重構它： </callout-info>
...
<callout-info class="aside"> 作為輔助資料，我有一個演講是關於這種語法的，你可
以[點擊觀看](https://www.youtube.com/watch?v=kTlcu16rSLc&list=PLV5CVI1eNcJgNqzNwcs4UKrlJdhfDjshf)
</callout-info>
