...
function SearchButton() {
  ...
  return (
    <>
      ...
      <Modal
        id="modal-search"
        className="bg-primary shadow-primary border-primary transition-height max-h-[80vh] w-[60rem] max-w-[60rem] duration-500 ease-in-out"
        backdropClass="items-start pt-10"
        open={visable}
