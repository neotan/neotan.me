      ...
      <div className="min-h-screen pt-8">
        <main className="container mx-auto flex gap-8 px-4 lg:max-w-6xl">
          <aside className="bg-mutedxx w-64 border p-4">
            ...
            <ul className="menu scrollbar-thin mt-4 overflow-y-auto" role='menu'>
              {Object.values(hashers)?.map(({ id, title }) => {
                return (
                  <li key={id} className="font-heading cursor-pointer" role='menuitem'>
                    <label className={`
                      flex cursor-pointer items-center justify-between !p-2 text-lg
                      hover:bg-card
                    `}>
                      <span>{title}</span>
                      {mounted &&
          ...
          <div className="flex w-full flex-col items-center gap-6 border p-4">
            <div className='w-full'>
              <Tabs className="" defaultValue="inputFiles" onValueChange={(val) => setSelectedFormat(val as InputFormats)}>
                ...
                <TabsContent value="inputText">
                  <Textarea
                    ...
                    className={cn(
                      `
                        font-code scrollbar-thin scrollbar-thumb-primary scrollbar-corner-primary
                ...
                <TabsContent value="inputFiles">
                  ...
                  >
                    ...
                    {isDragActive
                      ...
                      : (
                        <div className={`
                          font-heading flex size-full cursor-pointer flex-col items-center
...
function HashText({ className, algoName, rawData, hasher, myref }: HashTextProps) {
  ...
  return (
    <div suppressHydrationWarning className={cn('grid grid-cols-[1fr_4fr] py-5', className)}>
  ...
  return (
    <div className={cn('flex flex-col space-y-4 py-5', className)}>
      <div className="flex justify-between">
        ...
        {status === 'success' && (
          <div // TODO: add copy to clipboard
